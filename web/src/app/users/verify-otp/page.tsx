    ...
    <form onSubmit={handleSubmit(handleVerifyOtp)} className="flex justify-center items-center min-h-screen">
      <div className="w-1/3 border shadow-md rounded-md p-6">
        ...
        <p className="text-center my-4 text-sm">
          Informe o código OTP para ativar a sua conta.
        </p>
        ...
        <button className="w-full p-2.5 mt-2 border rounded-md bg-slate-950 hover:bg-slate-800 text-white font-semibold">Ativar Conta</button>
      </div>
    </form>
  );
}
